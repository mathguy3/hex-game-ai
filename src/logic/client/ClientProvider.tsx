...
export const ClientProvider = ({ children }: React.PropsWithChildren) => {
  ...
  const client: Omit<ServerRoutes, 'id'> = useMemo(
    () => ({
      ...
      listGameDefinitions: handler('listGameDefinitions'),
      getGameDefinition: handler('getGameDefinition'),
      createGameDefinition: handler('createGameDefinition'),
      updateGameDefinition: handler('updateGameDefinition'),
      deleteGameDefinition: handler('deleteGameDefinition'),
