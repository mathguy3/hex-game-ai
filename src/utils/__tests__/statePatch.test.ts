import { makeUnit } from '../../components/GameUI/HexMap/generation/initialMap';
...
describe('State Patch Utilities - Combined Operations', () => {
  ...
  it('should handle move + update operations', () => {
    ...
    const modified = {
      units: [unit2, { ...unit1, aspects: { ...unit1.aspects, health: { type: 'health', value: 75 } } }],
    };
  ...
  it('should handle update + remove operations', () => {
    ...
    const modified = {
      units: [{ ...unit1, aspects: { ...unit1.aspects, health: { type: 'health', value: 75 } } }, unit3],
    };
  ...
  it('should handle all operations combined', () => {
    ...
    const original = { units: [unit1, unit2, unit3] };
    const modified = {
      units: [unit4, { ...unit2, aspects: { ...unit2.aspects, health: { type: 'health', value: 75 } } }, unit1],
    };
