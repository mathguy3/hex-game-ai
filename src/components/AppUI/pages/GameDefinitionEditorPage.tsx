...
import { EditorRoot, setAtPath } from '../../../editor';
import { useGameDefinitionEditorRegistry } from '../hooks/useGameDefinitionEditorRegistry';
...
export const GameDefinitionEditorPage = () => {
  ...
  const registry = useGameDefinitionEditorRegistry();
