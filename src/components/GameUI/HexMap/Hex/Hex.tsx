...
export const Hex = React.memo(({ item, isSelected, preview, onSelectedRef }: HexProps) => {
  ...
  const shouldRotateTable = basicActionState.gameDefinition.rotateTable && basicActionState.localState.meId !== 'team1';
  ...
  console.log('rotateTable', shouldRotateTable);
  return (
    <Box
      position="absolute"
      left={shouldRotateTable ? -leftOffset : leftOffset}
      top={shouldRotateTable ? -topOffset : topOffset}
